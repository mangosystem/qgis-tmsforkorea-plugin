 ...
 * http://onetile1.map.naver.net/get/109/0/1/5/29/23/bl_st_bg
 */
...
OpenLayers.Layer.NaverSatellite = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    url: [
		"http://onetile1.map.naver.net/get/109/0/0/${z}/${x}/${y}/bl_st_bg/ol_st_an",
		"http://onetile2.map.naver.net/get/109/0/0/${z}/${x}/${y}/bl_st_bg/ol_st_an",
		"http://onetile3.map.naver.net/get/109/0/0/${z}/${x}/${y}/bl_st_bg/ol_st_an",
		"http://onetile4.map.naver.net/get/109/0/0/${z}/${x}/${y}/bl_st_bg/ol_st_an"
    ],
