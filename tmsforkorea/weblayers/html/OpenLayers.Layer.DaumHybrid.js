...
OpenLayers.Layer.DaumHybrid = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    url: [
    "http://map0.daumcdn.net/map_hybrid/2103dor/L${z}/${y}/${x}.png",
    "http://map1.daumcdn.net/map_hybrid/2103dor/L${z}/${y}/${x}.png",
    "http://map2.daumcdn.net/map_hybrid/2103dor/L${z}/${y}/${x}.png",
    "http://map3.daumcdn.net/map_hybrid/2103dor/L${z}/${y}/${x}.png"
    ],
