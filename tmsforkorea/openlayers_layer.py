...
class OpenlayersLayer(QgsPluginLayer):
  ...
  def __init__(self, iface, coordRSGoogle, olLayerTypeRegistry):
    QgsPluginLayer.__init__(self, OpenlayersLayer.LAYER_TYPE, "TMS for Korea layer")
    self.setValid(True)
    ...
    elif coordRSGoogle and coordRSGoogle.srsid() == 3857:
        # VWorld, MapBox, Google... 3857
        self.setExtent(QgsRectangle(-20037508.34, -20037508.34, 20037508.34, 20037508.34))
    else:
        # Daum, 5181 = -30000, -60000, 494288, 988576
        self.setExtent(QgsRectangle(-30000, -60000, 494288, 988576))
  ...
  def resolutions(self):
    if self.olResolutions == None:
      ...
      self.olResolutions = []
      for res in resVariant:
        self.olResolutions.append(res)
