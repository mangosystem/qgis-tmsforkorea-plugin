 ...
 * http://h3.maps.daum-img.net/map/image/G03/h/2015sheep/L1/7877/3439.png
 */
...
OpenLayers.Layer.DaumHybrid = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    name: "DaumHybridMap",
    url: [ 
		"http://h0.maps.daum-img.net/map/image/G03/h/2015sheep/L${z}/${y}/${x}.png",
		"http://h1.maps.daum-img.net/map/image/G03/h/2015sheep/L${z}/${y}/${x}.png",
		"http://h2.maps.daum-img.net/map/image/G03/h/2015sheep/L${z}/${y}/${x}.png",
		"http://h3.maps.daum-img.net/map/image/G03/h/2015sheep/L${z}/${y}/${x}.png"
    ],
