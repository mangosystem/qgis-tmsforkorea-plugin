...
OpenLayers.Layer.NaverCadstral = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    url: [
		"http://onetile1.map.naver.net/get/18/0/0/${z}/${x}/${y}/bl_vc_bg/ol_lp_cn",
		"http://onetile2.map.naver.net/get/18/0/0/${z}/${x}/${y}/bl_vc_bg/ol_lp_cn",
		"http://onetile3.map.naver.net/get/18/0/0/${z}/${x}/${y}/bl_vc_bg/ol_lp_cn",
		"http://onetile4.map.naver.net/get/18/0/0/${z}/${x}/${y}/bl_vc_bg/ol_lp_cn"
    ],
