...
OpenLayers.Layer.DaumStreet = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    url: [
    "http://map0.daumcdn.net/map_2d/1810uis/L${z}/${y}/${x}.png",
    "http://map1.daumcdn.net/map_2d/1810uis/L${z}/${y}/${x}.png",
    "http://map2.daumcdn.net/map_2d/1810uis/L${z}/${y}/${x}.png",
    "http://map3.daumcdn.net/map_2d/1810uis/L${z}/${y}/${x}.png"
    ],
