...
OpenLayers.Layer.DaumStreet = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    url: [
    "http://i0.maps.daum-img.net/map/image/G03/i/2015hunter/L${z}/${y}/${x}.png",
    "http://i1.maps.daum-img.net/map/image/G03/i/2015hunter/L${z}/${y}/${x}.png",
    "http://i2.maps.daum-img.net/map/image/G03/i/2015hunter/L${z}/${y}/${x}.png",
    "http://i3.maps.daum-img.net/map/image/G03/i/2015hunter/L${z}/${y}/${x}.png"
    ],
